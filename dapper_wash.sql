...
--
-- Host: localhost:3306
-- Waktu pembuatan: 12 Jan 2023 pada 11.43
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
(21, 'Noor Mohamad Alfaz', 'noormzzz07@gmail.com', 'default1.jpg', '$2y$10$JKsmV.KPMIOvnov5Rl9r1.S90K9f1NvNhVEtB6ZvaZJsyUcmz.RjK', 1, 1, 1668939115),
...
--
ALTER TABLE `user_role`
  MODIFY `id_user_role` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `user_token`
  MODIFY `id_user_token` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
COMMIT;
